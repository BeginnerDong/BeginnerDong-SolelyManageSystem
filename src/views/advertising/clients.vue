        ...
        <template v-slot:expand="expand">
            ...
            <div style="width:30%;height: auto;display: inline-block;vertical-align: top;padding: 8px 0;">
              ...
              <div style="margin-bottom: 5px;" v-for="(item,index) in expand.data.file" :key="index">
                  ...
                  <li v-else>文件名:&nbsp;<a :href="item.url" target="view_window">{{item.title}}</a></li>
              </div>
            </div>
    ...
    >
     <div style="overflow:hidden;zoom:1;text-align: left;padding: 2%;">
       ...
       <template v-for='(field,index) in fields' >
          ...
          >
            <div style="display: inline-block;width: 150px;text-align: left;font-weight: bold;vertical-align: top;">{{field.label}}：</div>
            <div style="display: inline-block;min-width: 225px;min-height: 50px;width: 100%;font-size: 12px;">
              <component
                :field="field"
